...
//    /* Example for 2) */
   ...
   static lv_color_t buf_2_1[MY_DISP_HOR_RES * MY_DISP_VER_RES/6] __attribute__((at(0XC0000000)));                        /*A buffer for 10 rows*/
   static lv_color_t buf_2_2[MY_DISP_HOR_RES *MY_DISP_VER_RES/ 6] __attribute__((at(0XC0000000+64000*2)));                        /*An other buffer for 10 rows*/
