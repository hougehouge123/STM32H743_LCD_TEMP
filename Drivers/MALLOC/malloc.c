...
/* 内存管理参数 */
const uint32_t memtblsize[SRAMBANK] = { MEM2_ALLOC_TABLE_SIZE
                                      };  /* 内存表大小 */

const uint32_t memblksize[SRAMBANK] = { MEM2_BLOCK_SIZE
                                      };  /* 内存分块大小 */

const uint32_t memsize[SRAMBANK] = { MEM2_MAX_SIZE
                                   };     /* 内存总大小 */
